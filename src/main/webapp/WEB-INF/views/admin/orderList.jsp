        ...
        <div class="table-responsive col-sm-10">
            <table class="table table-condensed">
                ...
                <tr>
                    ...
                    <td>${o.orderDate}</td>
                    <%
                        com.linkun.model.Order o = (com.linkun.model.Order) pageContext.findAttribute("o");
                        int userId = o.getCustomerId();
                        java.sql.Connection con = (java.sql.Connection) application.getAttribute("con");
                        com.linkun.dao.UserDao userDao = new com.linkun.dao.UserDao();
                    ...
                    <td class="cart_total">
                        <%
                            ...
                            String paymentType = com.linkun.model.Payment.findByPaymentId(con, n);
                        %>
